...
const IMAGES = [
  { 
    ...
    desc: "ANN automatically categorizes incoming emails, drafts context-aware responses, and flags high-priority items so you can achieve inbox zero effortlessly."
  },
  { 
    src: imgScheduling, 
    alt: "Meeting Scheduler",
    desc: "Coordinate calendars, analyze availability, and schedule meetings automatically. ANN finds the optimal time slot and handles invitations for your team."
  },
  { 
    src: imgTasks, 
    alt: "Smart Reminders",
    desc: "Never miss a deadline. ANN monitors your active projects, sets intelligent reminders, and sends proactive notifications based on real-time task progress."
  },
  { 
    src: imgInsights, 
    alt: "Data Analytics",
        ...
        <div style={getOverlayStyle()} className="overflow-hidden flex flex-col justify-between">
          ...
          <div className="absolute top-8 left-0 right-0 z-30 container mx-auto px-6 pointer-events-none">
            <div className="max-w-2xl">
              ...
              >
                Powered by <span className="text-primary">ANN</span>
              </motion.h2>
            </div>
          </div>
