...
const REVIEWS = [
  {
    ...
    content: "AiSence has completely transformed how I manage my day. It schedules meetings, drafts emails, and reminds me of deadlines — all without me lifting a finger. It's like having a genius assistant 24/7.",
    initials: "ER",
    color: "#6600FF",
  },
  {
    ...
    content: "The natural language understanding is incredible. I just tell AiSence what I need, and it handles everything — from booking flights to summarizing reports. It's saved me hours every single week.",
    initials: "MC",
    color: "#5EC900",
  },
  {
    ...
    content: "I was skeptical about AI assistants, but AiSence is different. It actually learns my preferences and gets smarter over time. My productivity has increased by at least 40% since I started using it.",
    initials: "SJ",
    color: "#EFA758",
  },
];
