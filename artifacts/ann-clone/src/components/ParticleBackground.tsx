...
function pickColor(a: number) {
  return COLORS[Math.floor(Math.random() * COLORS.length)].replace("VAL", String(a));
}
...
export function ParticleBackground({
  ...
  useEffect(() => {
    ...
    const draw = (timestamp: number) => {
      ...
      g1.addColorStop(0, "rgba(102,0,255,0.065)"); g1.addColorStop(1, "transparent");
      ...
      g2.addColorStop(0, "rgba(0,200,212,0.04)"); g2.addColorStop(1, "transparent");
